...
const {Tables} = require("@/ecam_backend");
...
/*
let industry_estimations_prova = {

    wwt_vol_disc: function(stepper_model, wwtp_model, wwtp){
        if(stepper_model == 2){
    ...
    wwt_vol_reused: function(stepper_model, wwtp_model){
        if(stepper_model == 2){
            return wwtp_model.wwt_vol_trea - wwtp_model.wwt_vol_disc - wwtp_model.wwt_vol_treated_external
        }
        return null
    },
    wwt_vol_treated_external: function(stepper_model, wwtp_model){
        if(stepper_model == 2){
            return wwtp_model.wwt_vol_trea - wwtp_model.wwt_vol_disc - wwtp_model.wwt_vol_reused
        }
        return null
    },
    ind_pollutants_effl: function(industry, pollutant){
        if (pollutant == "COD"){
            if(industry.industry_type === 1){  //noves categories
                return 336.2591324200910/2.4
            }else if(industry.industry_type === 2){  //noves categories
                return 231.09062980030700/2.4
            }else if(industry.industry_type === 4){  //noves categories
                return 410.09920634920627/2.4
            }else if(industry.industry_type === 5){  //noves categories
                return 40/2.4
            }else if(industry.industry_type === 6){  //noves categories
                return null
            }else if(industry.industry_type === 7){  //noves categories
                return 33.333333333333336/2.4
            }else if(industry.industry_type === 8){  //noves categories
                return 366.27272727272725/2.4
            }else if(industry.industry_type === 9){  //noves categories
                return 750/2.4
            }else if(industry.industry_type === 10){  //noves categories
                return 300/2.4
            }else if(industry.industry_type === 11){  //noves categories
                return 598.8096590909091/2.4
            }else if(industry.industry_type === 12){  //noves categories
                return 559.8717948717948/2.4
            }else if(industry.industry_type === 13){  //noves categories
                return 603.1034482758621/2.4
            }else if(industry.industry_type === 14){  //noves categories
                return 59.03846153846154/2.4
            }else if(industry.industry_type === 15){  //noves categories
                return 586.5384615384615/2.4
            }else if(industry.industry_type === 16){  //noves categories
                return 641.4117647058823/2.4
            }else if(industry.industry_type === 17){  //noves categories
                return 33.333333333333336/2.4
            }else if(industry.industry_type === 18){  //noves categories
                return 86.66666666666667/2.4
            }else if(industry.industry_type === 19){  //noves categories
                return 328.75/2.4
            }else if(industry.industry_type === 20){  //noves categories
                return 563.1578947368421/2.4
            }else if(industry.industry_type === 21){  //noves categories
                return null
            }else if(industry.industry_type === 22){  //noves categories
                return 35/2.4
            }else if(industry.industry_type === 23){  //noves categories
                return 35/2.4
            }else if(industry.industry_type === 24){  //noves categories
                return 40/2.4
            }else return null
    ...
    wwt_pollutants_effl: function(wwtp, wwtp_model, pollutant){
        if (pollutant == "COD"){
    ...
    wwt_biog_pro: function(wwtp_model){
    ...
    wwt_cod_slud: function(wwtp_model){
        return Tables["type_of_treatment_KREM"].map(option => {
            return {
                name: option.name,
                value: option.K_rem * wwtp_model.wwt_mass_slu
            }
        })
    },
...
let industry_estimations = {
    get_estimation(estimation, industry, industry_model, stepper_model, wwtp, wwtp_model, pollutant){
        let industry_estimations = {
...
module.exports = industry_estimations