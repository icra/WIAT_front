  ...
  methods: {
    ...
    tab_1_continue(){
      ...
      for(let input of ['level_of_certainty', ...this.industry_inputs]){
        ...
        else if (input == 'product_produced_unit'){
          this.industry[input] = this.industry_model[input]
        }
