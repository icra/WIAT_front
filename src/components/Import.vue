...
export default {
  ...
  data() {
    return {
      ...
      items_excel_type: [{value:'Industry locations', key: 'industry_locations'}, {value: 'Industry questionnaire', key: "industry_questionnaire"}],
  ...
  methods: {
    ...
    async onUploadExcel(){
      if (this.excel_type.key === "industry_locations") {
